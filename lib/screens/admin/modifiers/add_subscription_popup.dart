...
class CustomerSelectionPopup extends StatefulWidget {
  final Function(String) onSelectCustomer;

  const CustomerSelectionPopup({required this.onSelectCustomer, Key? key})
      : super(key: key);

  @override
  _CustomerSelectionPopupState createState() => _CustomerSelectionPopupState();
}

class _CustomerSelectionPopupState extends State<CustomerSelectionPopup> {
